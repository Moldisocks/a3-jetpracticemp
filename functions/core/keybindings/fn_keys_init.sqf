...
keys_functions = ["Earplugs","Jump","Player Menu","Enemy AI spawn menu"];//List of actions that require a custom hardcoded keybinding. Must match indexing of the keyhandler and the var keys_bindings.
