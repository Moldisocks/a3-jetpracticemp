...
jets_defaultLoadouts = [
	["B_PLANE_CAS_01_F",[["Cannon_30mm_Plane_CAS_02_F",2],["weapon_AGM_65Launcher",4]]], //Example of vehicle with 2 weapons attached.
	["O_PLANE_CAS_02_F",["weapon_AGM_65Launcher",2]], //Example of vehicle with only 1 weapon attached. Note the missing [] brackets.
	["I_PLANE_FIGHTER_03_CAS_F"] //This vehicle is ignored, and it's loadout will be default.
];